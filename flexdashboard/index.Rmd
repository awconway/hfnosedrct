...
Clinical and demographic variables {data-navmenu=Data data-icon="fa-database"}
=======================================================================
...
TcCO2 {data-navmenu=Data data-icon="fa-database"}
=======================================================================

```{r}
drake::readd(tcco2_data) %>%
  downloadthis::download_this(
    output_name = "tcc02-dataset",
...
```{r, tcco2-chunk}
reactable::reactable(drake::readd(tcco2_data),
                    filterable = TRUE,
                    searchable = TRUE,
                    pagination = FALSE, 
                    groupBy = "id",
...
Reproducibility {data-navmenu=Data data-icon="fa-repeat"}
=======================================================================

<iframe style="border:none" src="https://hfnosedrct.netlify.com" height="100%" width="100%"></iframe>
