...
Overall, there were few adverse sedation events, as measured by the TROOPS tool. As  The odds ratio for a minor adverse airway or breathing outcome for the HFNO group compared with the facemask group was estimated to be `r CI_troops[["full"]]`. 

The effect of treatment on average ISAS score was estimated by the robust regression model to be `r CI_isas[["full"]]`, where the effect is measured in units of absolute difference. Average ISAS scores from three participants were not calculated due to missing responses for some of the component ISAS items.
...
Participants randomized to the HFNO group received flow rates at 50 litres per minute or higher for the majority of the time (Figure \@ref(fig:oxygenplot)). 
